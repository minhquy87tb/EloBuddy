...
namespace SimpleCorki
{
    class Activator
    {
        ...
        private static void Game_OnStart(EventArgs args)
        {
            ...
            Menu.Add("useMura", new CheckBox("Use Muramana", true));
        ...
        private static void Game_OnTick(EventArgs args)
        {
            ...
            if (!Orbwalker.ActiveModesFlags.HasFlag(Orbwalker.ActiveModes.Combo) && Player.Instance.HasBuff("Muramana"))
            {
                var MuraCheck = _Player.InventoryItems.FirstOrDefault(a => a.Id == (ItemId)3042);
                Player.CastSpell(MuraCheck.SpellSlot);
            }
        ...
        private static void Combo()
        {
            ...
            if(MuraCheck != null && Menu["useMura"].Cast<CheckBox>().CurrentValue && !Player.Instance.HasBuff("Muramana"))
            {
                var itSlot = MuraCheck.SpellSlot;
